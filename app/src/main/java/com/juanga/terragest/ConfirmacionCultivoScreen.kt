...
fun ConfirmacionCultivoScreen(
    ...
    Column(
        ...
        Text(text = "¡Guardado con éxito!", fontSize = 22.sp, fontWeight = FontWeight.Bold, color = Color.Black, textAlign = TextAlign.Center)
        ...
        BotonPrincipalVerde(textoDelBoton = "Listo", alHacerClic = onNavegarListo)
